...
const Explore = () => {
  ...
  const displayedJobs = jobs.filter((job) => {
    ...
    const typeLower = job.job_type ? job.job_type.toLowerCase() : "";
    ...
    // 2. Sidebar logic (Checks strictly for Part-Time or Internship)
    let matchesFilter = true;
    if (activeFilter === "Part-Time") matchesFilter = typeLower.includes("part-time");
    if (activeFilter === "Internship") matchesFilter = typeLower.includes("internship");
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {/* --- FLEX CONTAINER: SIDEBAR + FEED --- */}
      <div className="flex flex-col lg:flex-row gap-8">
        
        {/* --- LEFT SIDEBAR (STICKY DASHBOARD) --- */}
        <aside className="w-full lg:w-1/4">
          <div className="bg-gray-800/40 border border-gray-700 rounded-3xl p-6 sticky top-24 backdrop-blur-md shadow-2xl">
            <h2 className="text-xl font-bold text-white mb-6">Quick Filters</h2>
        ...
        <section className="w-full lg:w-3/4">
          ...
          <div className="bg-gray-800/40 border border-gray-700 rounded-2xl p-4 mb-6 backdrop-blur-sm shadow-lg">
          ...
          <div className="mb-4 flex justify-between items-end px-2">
             <h2 className="text-2xl font-bold text-gray-200">
               {activeFilter === "All" ? "Latest Openings" : `${activeFilter}s`}
             </h2>
            ...
            {displayedJobs.length > 0 ? (
              displayedJobs.map((job) => (
                <div key={job.job_id} className="relative bg-gray-800/40 border border-gray-700 rounded-2xl p-6 hover:border-emerald-500/50 transition-colors shadow-lg flex flex-col justify-between h-full">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-white mb-1 pr-10">{job.title}</h3>
              ...
              <div className="col-span-full bg-gray-800/20 border border-gray-700/50 rounded-2xl p-12 text-center">
